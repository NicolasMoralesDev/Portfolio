...
const Contacto = () => {
  return (
    <div className="flex p-5 justify-center flex-col items-center gap-4 w-full h-1/5">
      <h2 className='text-4xl'>Contacto</h2>
      <div className='flex items-center flex-col h-1/3 w-64 p-5  rounded-xl bg-red-800'>
