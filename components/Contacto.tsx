...
const Contacto = () => {
  return (
    <div className="flex p-5 contacto_container justify-center flex-col items-center gap-4 w-full h-1/5">
      <h2 className='text-4xl text-white font-bold '>Dejame tu Mensaje</h2>
      <div className='form_container flex items-center flex-col h-1/3 w-72 p-5   bg-red-800'>
        <form action="https://formsubmit.co/nicolasmoralesj03@gmail.com" method="POST" className=' text-white flex items-center flex-col gap-4'>
          ...
          <textarea name="consulta" id="consulta" required placeholder='ingrese su mensaje' cols={20} rows={5}></textarea>
          ...
          <input type="hidden" name="_next" value="https://nicolas-morales-portfolio.vercel.app"/>
